...
question_templates_all={
    'template1':'For the variable {variable_text1}, was the maximum value higher or lower for patient {patient1} compared to patient {patient2}?',
    'template2':'Was the minimum {variable_text1} higher or lower for patient {patient1} compared to patient {patient2}?',
    'template3':'For patient {patient1}, was the average {variable_text1} higher or lower compared to patient {patient2}?',
    'template4':'Was the {variable_text1} increasing faster for patient {patient1} or patient {patient2} during the first {time1} hours of their ICU stay?',
    'template5':'Was the {variable_text1} decreasing faster for patient {patient1} or patient {patient2} during the first {time1} hours of their ICU stay?',
    'template6':'Compard to the average among all patients who did not expire in the hospital, was the average {variable_text1} of patient {patient1} from hour {time1} to {time2} higher or lower?', 
    'template7':'Was the average {variable_text1} of patient {patient1} from hour {time1} to {time2} higher or lower than the average among all patients who expired in the hospital?', 
    'template8':'Compared to the average among all patients with {phenotype_text1}, was the average {variable_text1} of patient {patient1} from hour {time1} to {time2} higher or lower?', 
    'template9': 'Between hour {time1} and {time2}, what time was {variable_text1} the highest for patient {patient1}?',
    'template10': 'At what time did {variable_text1} reach its lowest value for patient {patient1} between hour {time1} and {time2}?',
    'template11': 'The {variable_text1} for patient {patient1} increased the most at what time?',
    'template12': 'For patient {patient1}, at what timepoint did {variable_text1} decrease the most?',
    'template13': 'For patient {patient1}, is {variable_text1} expected to be above or below the average {variable_text1} among patients with {phenotype_text1} at hour {time3} based on the data from hour {time1} to {time2}?',
    'template14': 'Based on the data from hour {time1} to {time2}, is {variable_text1} for patient {patient1} expected to be above or below the highest average {variable_text1} among patients with {phenotype_text1} at hour {time3}?',
    'template15': 'Is {variable_text1} for patient {patient1} expected to be above or below the lowest average {variable_text1} among patients with {phenotype_text1} at hour {time3} based on the data from hour {time1} to {time2}?'
...
while len(question_df) < total_questions:
    ...
    question_df
    question_df.to_csv('./mimiciii_icu_qa_benchmark.txt',sep='\t')
    print('\n\n\n')
    print(question_df)
    import time
    time.sleep(5)
